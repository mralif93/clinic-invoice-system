    ...
    <div class="space-y-6">
        ...
        <div class="relative overflow-hidden rounded-3xl bg-white/90 dark:bg-gradient-to-b dark:from-slate-800/90 dark:to-slate-900/90 backdrop-blur-xl border border-slate-200 dark:border-indigo-900/60 p-7 sm:p-9 shadow-2xl shadow-slate-300/50 dark:shadow-slate-950/60 transition-colors">
            ...
            <form action="{{ route('password.email') }}" method="POST" class="space-y-4">
                ...
                <button
                    type="submit"
                    class="w-full mt-3 py-3.5 px-4 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-sm shadow-xl shadow-indigo-600/30 border border-indigo-500/30 transition-all flex items-center justify-center gap-2 transform active:scale-[0.98]"
                >
            ...
            <div class="mt-6 pt-5 border-t border-slate-200 dark:border-slate-700/60 text-center">
                <a href="{{ route('login') }}" class="inline-flex items-center gap-1.5 text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 transition">
